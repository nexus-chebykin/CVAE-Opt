...
def plot_optimizer_comparison_iterations_pct(
    ...
    colors = {"DE": "#E63946", "CMA-ES": "#2A9D8F", "IPOP-CMA-ES": "#F1A208", "BIPOP-CMA-ES": "#6A4C93", "Scipy-DE": "#264653", "EvoX-JADE": "#8B4789", "Pygmo-PSO-Gen": "#FF6B9D", "EvoX-SHADE": "#E07A5F", "EvoX-SaDE": "#4ECDC4", "EvoX-CoDE": "#F4A261", "EvoX-ODE": "#95B8D1", "NGOpt": "#E74C3C"}
