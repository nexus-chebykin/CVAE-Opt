...
def get_config(inJupyter=False):
    ...
    parser.add_argument('--KLD_weight', default=1e-2, type=float)  # Beta in the paper. Default was None, but for tsp default should be™ 1e-2
    parser.add_argument('--lr', default=2.5e-3, type=float)
    parser.add_argument('--use_transformer_encoder', default=True, type=bool)
    parser.add_argument('--use_transformer_decoder', default=True, type=bool)
    parser.add_argument('--instances_path', type=str, default="instances/tsp/training/tsp_100_instances.zip")
    parser.add_argument('--solutions_path', type=str, default="instances/tsp/training/tsp_100_solutions.zip")
    ...
    args = [] if inJupyter else None # Hack to not get cancer in Jupyter
