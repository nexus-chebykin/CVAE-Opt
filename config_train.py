...
def get_config(inJupyter=False):
    ...
    parser.add_argument('--search_batch_size', default=1200, type=int)
    # double or triple both above
    ...
    parser.add_argument('--instances_path', type=str, default="instances/tsp/training/tsp_20_instances.zip")
    parser.add_argument('--solutions_path', type=str, default="instances/tsp/training/tsp_20_solutions.zip")
