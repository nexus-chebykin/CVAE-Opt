# ------------------------------------------------------------------------------+
# EvoX ODE (Oppositional Differential Evolution)
# Implementation using the EvoX optimization library
#
# Reference: https://evox.readthedocs.io/en/latest/apidocs/evox/evox.algorithms.so.de_variants.ode.html
# ODE: Rahnamayan, S., Tizhoosh, H. R., & Salama, M. M. (2008). Opposition-based
...
import time
import torch
from evox.algorithms.so.de_variants import ODE
...
def minimize(cost_func, args, search_space_bound, search_space_size, popsize,
    ...
    ODE (Oppositional DE) uses opposition-based learning to improve exploration
    by simultaneously considering opposite points in the search space, which can
    ...
    # Initialize ODE algorithm
    # ODE uses opposition-based learning for initialization and generation jumping
    # Reference: https://evox.readthedocs.io/en/latest/apidocs/evox/evox.algorithms.so.de_variants.ode.html
